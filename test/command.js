/*
 * test/command.js - Tests for confson CLI
...
describe('command', function() {
	...
	it('accepts file -> file', function(done) {
		exec('node confsoncmd.js test/data/sample.sbconf output.json', function(err, stdout, stderr) {
	...
	it('accepts STDIN -> file', function(done) {
		exec('node confsoncmd.js - output.json <test/data/sample.sbconf', function(err, stdout, stderr) {
			expect(err).to.be.not.ok;
			expect(stdout).to.be.a.string;
			expect(stdout).to.be.not.ok;
			expect(stderr).to.be.not.ok;
	...
	it('accepts pipemode (-p)', function(done) {
		exec('node confsoncmd.js -p <test/data/sample.sbconf >output.json', function(err, stdout, stderr) {
			expect(err).to.be.not.ok;
			expect(stdout).to.be.a.string;
			expect(stdout).to.be.not.ok;
			expect(stderr).to.be.not.ok;
